...
import com.seeyon.v3x.dee.context.TransformContextImpl;
...
public class ImportFlow extends BaseDAO {
	...
	public void doWriter(String xml) throws TransformException, DocumentException {
		...
		if(doc.getContext()==null){
			...
			TransformContext context = new TransformContextImpl(params,null);
			doc.setContext(context);
			//强制jdbcWriter单线程运行，防止外键影响
			doc.getContext().getParameters().add("dee.default.threadNum", "1");
		} 
		r.execute(doc);
